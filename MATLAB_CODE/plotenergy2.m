...
plot(tsub,  F(1:step:minindex),'-','LineWidth',2,'Color','k'); hold on;
plot(tsub,  U(1:step:minindex),'-','LineWidth',2,'Color','r'); hold on;
%plot(tsub, -S(1:step:minindex)+S(2),'-','LineWidth',2,'Color','b'); hold on;

plot(tsub, -Sc0(1:step:minindex),'-','LineWidth',2,'Color','b'); hold on;
plot(tsub, -Sc1(1:step:minindex),'-','LineWidth',2,'Color','g'); hold on;
