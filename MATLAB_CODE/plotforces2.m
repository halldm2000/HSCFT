...
semilogy(tsub,eforceSub,'r-','LineWidth',2); hold on
semilogy(tsub,oforceSub,'b-','LineWidth',2); hold on
semilogy(tsub,wforceSub,'g-','LineWidth',2); hold on
semilogy(tsub,vforceSub,'k-','LineWidth',2); hold on
hold off;
