function m = tsequence_isophis_cutaway2g(which,targetTimes,smoothval,rep,cutFracs1,cutFracs2)
%figure(1);
...
dy = 1/m;
  for r=1:m
    for c=1:n
        ...
        isophis_cutaway2g(which,step,smoothval,rep,cutFracs1,cutFracs2)
