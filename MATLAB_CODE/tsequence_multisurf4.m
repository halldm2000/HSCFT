function m = tsequence_multisurf4(targetTimes,rep)
figure(1); clf;
...
dy = 1/m;
  for r=1:m
    for c=1:n
        ...
        multisurf4(step,rep);
        axis off;
        text(0.5,1.1,1,sprintf('t=%.1f',round(time*10)/10),'Color',[.95 1 .95],'FontSize',12,'FontWeight','bold');%,'Background',[0 0 0]);     
        zlim([0 1]);
        drawnow
    end
  end